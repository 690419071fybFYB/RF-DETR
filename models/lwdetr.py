...
class OutputScaler(nn.Module):
    """
    Tiny module to demonstrate partial checkpoint loading.
    It applies a learnable scalar to every tensor passed through it.
    """
...
class LWDETR(nn.Module):
    ...
    def __init__(self,
        ...
        self._export = False
        self.logit_scaler = OutputScaler()
    ...
    def forward(self, samples: NestedTensor, targets=None):
        ...
        if hs is not None:
            ...
            outputs_class = self.logit_scaler(self.class_embed(hs))
